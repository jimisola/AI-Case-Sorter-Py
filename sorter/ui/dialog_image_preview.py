...
class ImagePreviewDialog(tk.Toplevel):
    def __init__(
        ...
        *,
        ...
        ttk.Label(
            wrap, text=f"Classification: {self._current}    File: {self._path.name}",
        ...
        ttk.Button(row, text="Reclassify", command=self._reclassify,
                   style="Accent.TButton").pack(side=tk.LEFT)
        ttk.Button(row, text="Delete", command=self._delete,
