...
qtui pattern for that (mirrors ``conftest.drain_until``'s bounded poll, but
...
from sorter.qtui.dialog_image_preview import ImagePreviewDialog
from sorter.qtui.dialog_model_images import ModelImagesDialog
