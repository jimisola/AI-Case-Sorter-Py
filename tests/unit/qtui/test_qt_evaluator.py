...
from sorter.qtui.dialog_model_evaluator import (
    UNMAPPED,
    ClassMapperDialog,
...
def test_rows_carry_the_match_status_as_a_color(dialog, qapp, tmp_path) -> None:
    """The Tk table tagged rows green/red/muted; the brush is the Qt form of that."""
    folder = tmp_path / "labelled"
...
def test_history_lists_existing_reports_newest_first(dialog, model) -> None:
    ...
    # No selection: "Open in browser" falls back to the newest, like Tk.
